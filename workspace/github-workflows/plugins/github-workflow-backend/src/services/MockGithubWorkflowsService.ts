...
/**
 * Mock implementation of GithubWorkflowsServiceApi for development and testing.
 * Returns realistic fixture data without making any GitHub API calls.
 *
 * @public
 */
export class MockGithubWorkflowsService implements GithubWorkflowsServiceApi {
  async listWorkflows(
    _hostname: string,
      ...
      jobs: [
        {
          ...
          steps: [
            { name: 'Checkout', status: 'completed', conclusion: 'success', number: 1, started_at: '2024-06-15T12:00:00Z', completed_at: '2024-06-15T12:00:10Z' },
            { name: 'Install', status: 'completed', conclusion: 'success', number: 2, started_at: '2024-06-15T12:00:10Z', completed_at: '2024-06-15T12:02:00Z' },
            { name: 'Build', status: 'completed', conclusion: 'success', number: 3, started_at: '2024-06-15T12:02:00Z', completed_at: '2024-06-15T12:04:30Z' },
            { name: 'Test', status: 'completed', conclusion: 'success', number: 4, started_at: '2024-06-15T12:04:30Z', completed_at: '2024-06-15T12:05:00Z' },
          ],
        },
        {
          id: 8002,
