...
| gitlab-pipelines | `plugins/gitlab-pipelines`, `plugins/gitlab-pipelines-common`, `plugins/gitlab-pipelines-backend` | `@veecode-platform/gitlab-pipelines-common`, `@veecode-platform/backstage-plugin-gitlab-pipelines-backend` | Yes | Scaffolded with an empty backend plugin |
