...
`workspaces/dummy` remains the existing reference fixture and is not regenerated by
the scaffold. Use the template for new workspaces and dummy for accumulated examples
